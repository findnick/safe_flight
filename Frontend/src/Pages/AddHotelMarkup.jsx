...
export default function AddHotelMarkup() {
  ...
  const saveValues = () => {
    localStorage.setItem("hotel-markup", markup);
  };

  useEffect(() => {
    if (!localStorage.getItem("hotel-markup"))
      localStorage.setItem("hotel-markup", 10);
    setMarkup(localStorage.getItem("hotel-markup"));
  }, []);

  return (
    <div className="flex flex-col gap-5">
      <FormGroup
        labelText="Hotel Markup"
        input={{
          type: "text",
          name: "markup",
          id: "markup",
